...
void setup() {
   ...
   ledcAttachPin(15, 9); //pin, channel
   ledcSetup(9, 50, 16); //channel, freq, resol
}
...
// Serial.println(iIncomingByte, HEX);        // uncomment to output received character
 ...
 else
 {
    ...
    if (millis() - CR1_ulLastByteTime > CR1_clReadTimeout) {
      CR1_ui8IRDatum = 0;                     // if so, clear incoming byte **************sets that we lost the becon*************
    }
 }
 ...
 if(CR1_ulMainTimerNow - CR1_ulMainTimerPrevious >= CR1_ciMainTimer)
 {
         ...
         CR1_ulMotorTimerPrevious = CR1_ulMotorTimerNow;
             if (counter3==0){
                 switch(ucMotorStateIndex)
                 {
                  ...
                  case 1: //how many counts each motor moves
                  {
                    ENC_SetDistance(100, 125);
                  ...
                  case 2: //how many counts each motor moves
                  {
                    ENC_SetDistance(110, 130);
                    ucMotorState = 4;   //forward
                    CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed;
                    CR1_ui8RightWheelSpeed = CR1_ui8WheelSpeed;
                    ucMotorStateIndex = 3;          
                  ...
                  case 3: //turn to left turn 1
                  {
                     ENC_SetDistance(-16,16); //adjusting these
                     CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed;
                     CR1_ui8RightWheelSpeed = CR1_ui8WheelSpeed;
                     ucMotorState = 3;  //left?
                     //counter2 = counter2+1;
                   ...
                   case 4: //how many counts each motor moves
                  {
                    ENC_SetDistance(100, 120);
                    ucMotorState = 4;   //forward
                    CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed;
                    CR1_ui8RightWheelSpeed = CR1_ui8WheelSpeed;
                    ucMotorStateIndex = 5;          
                  ...
                  case 5: //how many counts each motor moves
                  {
                    ENC_SetDistance(110, 130);
                    ucMotorState = 4;   //forward
                    CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed;
                  ...
                  case 6: //turn to right
                  {
                     ENC_SetDistance(10,-10); // turn 2
                     CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed;
                     CR1_ui8RightWheelSpeed = CR1_ui8WheelSpeed;
                   ...
                   case 7: //how many counts each motor moves
                  {
                    ENC_SetDistance(100, 120);
                    ucMotorState = 4;   //forward
                    CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed;
                  ...
                  case 8: //how many counts each motor moves
                  {
                    ENC_SetDistance(120, 135);
                    ucMotorState = 4;   //forward
                    CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed;
                    CR1_ui8RightWheelSpeed = CR1_ui8WheelSpeed;
                    ucMotorStateIndex = 9;          
                  ...
                  case 9: //turn to right
                  {
                     ENC_SetDistance(13,-13); //turn 3
                     CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed;
                     CR1_ui8RightWheelSpeed = CR1_ui8WheelSpeed;
                     ucMotorState = 2;  //right
                     //counter2 = counter2+1;
                  ...
                  case 10: //how many counts each motor moves
                  {
                    ENC_SetDistance(120, 135);
                    ucMotorState = 4;   //forward
                    CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed;
                  ...
                  case 11: //how many counts each motor moves
                  {
                    ENC_SetDistance(120, 135);
                    ucMotorState = 4;   //forward
                    CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed;
             ...
             /*if (counter1 == 1){
                   switch(ucMotorStateIndex)
                 {
                  ...
                  case 1: //turn to check left times
                  {
                  ...
                  case 6:
                    {
                      ucMotorStateIndex = 7;
                      ledcWrite(9, degreesToDutyCycle(80));
                      break;
                    }
                 }//end of switch
              }*/
            if(CR1_ui8IRDatum == 0x55 && counter1 == 0){
               switch(ucMotorStateIndex)
                 {
                  case 0: // waiting
                  {
              ...
              if(CR1_ui8IRDatum != 0x41 && CR1_ui8IRDatum != 0x55){
                ...
                if (counter1 == 0 ){//&& counter2 <= 2
                      switch(ucMotorStateIndex)
                     {
                      ...
                      case 2: //small backup to check light (not in use atm)
                      {
                        ucMotorState = 1;  //reverse
                ...
                /*else if (counter1 == 0 && counter2 > 2 && counter2<=6){
                      switch(ucMotorStateIndex)
                     {
                      case 0: // waiting
                      {
   ...
   //   asm volatile("esync; rsr %0,ccount":"=a" (vui32test2)); // @ 240mHz clock each tick is ~4nS 
    ...
    case 3: 
    {
      ...
      {
        MoveTo(ucMotorState, CR1_ui8RightWheelSpeed,CR1_ui8LeftWheelSpeed); //direction,wheel speed
      }
    ...
    case 7: // smart leds
    {
       if (CR1_ui8IRDatum == 0x55) {                // if proper character is seen
         SmartLEDs.setPixelColor(0,0,25,0);         // make LED1 green with 10% intensity lednumber,red,green,blue
       }
