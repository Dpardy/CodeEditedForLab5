       ...
       {   
         ...
         if (counter1 == 1){
               switch(ucMotorStateIndex)
             {
              ...
              case 3: //how many counts each motor moves
              {
                ucMotorState = 1;  //reverse
                ENC_SetDistance(-400, -450);
                CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed;
              ...
              case 5:
                {
                  ucMotorStateIndex = 5;
                  ledcWrite(9, degreesToDutyCycle(85));
                  break;
                }
             }//end of switch
          }
            ...
            if (counter1 == 0 ){//&& counter2 <= 2
                  switch(ucMotorStateIndex)
                 {
                  case 0: // waiting
                  {
                   ...
                   case 1: //turn to check right 3 times
                  {
                      ENC_SetDistance(5,-5);
                      CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed;
                      CR1_ui8RightWheelSpeed = CR1_ui8WheelSpeed;
